...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-[#0b0e14] flex flex-col lg:flex-row overflow-hidden selection:bg-[#00e5ff] selection:text-[#0b0e14]">
      {/* Left Side: Value & Auth */}
      <div className="w-full lg:w-[45%] flex flex-col p-6 sm:p-8 lg:p-16 z-10 bg-[#0b0e14] overflow-y-auto custom-scrollbar">
        ...
        <div className="mt-auto pt-8 flex items-center justify-between shrink-0 border-t border-white/5">
      ...
      <div className="hidden lg:flex flex-1 relative items-center justify-center bg-[#0b0e14] overflow-hidden">
        {/* Ambient Glow */}
